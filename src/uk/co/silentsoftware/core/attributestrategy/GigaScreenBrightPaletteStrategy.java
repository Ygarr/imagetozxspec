...
/**
 * Palette derived from both screens having a bright attribute.
 */
public class GigaScreenBrightPaletteStrategy implements GigaScreenAttributeStrategy {

	@Override
	public GigaScreenAtrribute[] getPalette() {
		return SpectrumDefaults.GIGASCREEN_BRIGHT_COMBOS;
	}

	@Override
	public String toString() {
		return getCaption("attr_giga_bright") ;
	}
}
